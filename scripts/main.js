...
function setUserName() {
  ...
  myHeading.innerHTML  = 'Mozilla is cool, ' + myName;		//innerHTML-свойство переменной,котор представляет собой контент заголовка
}
if(!localStorage.getItem('name')) {							// проверяем нет ли в апи данных
  ...
  myHeading.innerHTML  = 'Mozilla is cool, ' + storedName;  //и дописываем к строке
}
